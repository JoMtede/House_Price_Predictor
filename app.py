...
st.write("This app uses machine learning to predict house prices with given features of the house. To use this app you can enter the inputs fro this IU and then use the predict button")
...
else :st.write("Please use predict button after entering values")
